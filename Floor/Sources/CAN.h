...
// change value of FLOORNUMBER for different floor operation
#define FLOORNUMBER 2
...
// Definition of IDs
    #define FLOOR_TX_ID 0x40200000    // Standard ID 0x201 formatted to be loaded in IDRx registers in Tx buffer
    #define FLOOR_NUM 0x01
...
// Definition of IDs
    #define FLOOR_TX_ID 0x40400000    // Standard ID 0x202 formatted to be loaded in IDRx registers in Tx buffer
    #define FLOOR_NUM 0x02
...
// Definition of IDs
    #define FLOOR_TX_ID 0x40600000    // Standard ID 0x203 formatted to be loaded in IDRx registers in Tx buffer
    #define FLOOR_NUM 0x03
